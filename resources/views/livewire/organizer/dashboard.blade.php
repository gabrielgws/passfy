                ...
                @if ($upcomingEvents->count() > 0)
                    <div class="space-y-4">
                        @foreach ($upcomingEvents as $event)
                            <div
                                class="border rounded-lg p-4 flex flex-col md:flex-row justify-between items-start md:items-center">
                                <div>
                                ...
                                <div class="mt-2 md:mt-0 flex space-x-2">
                                    ...
                                    <a href="{{ route('organizer.event.scan', $event) }}"
                                        class="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded">Validar</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
